...
export class FirstMigration1601343661948 implements MigrationInterface {
    name = 'FirstMigration1601343661948'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "adoptions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "adoptionDate" TIMESTAMP NOT NULL, "donatedBy" character varying NOT NULL, "observations" character varying NOT NULL, "adopterId" uuid, "animalId" uuid, "resposabilityStatementId" uuid, CONSTRAINT "REL_9111108e9c15eb001f71cda50e" UNIQUE ("animalId"), CONSTRAINT "REL_eea2d4d90da26763e31010e184" UNIQUE ("resposabilityStatementId"), CONSTRAINT "PK_f3897fdb8f8f34600711b59183b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "adoptionsRate_type_enum" AS ENUM('PAYED', 'FREE')`);
        await queryRunner.query(`CREATE TABLE "adoptionsRate" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "type" "adoptionsRate_type_enum" NOT NULL, "value" integer NOT NULL, CONSTRAINT "PK_f1aa5aaded07586ec956f92336d" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "adoptionsRate"`);
        await queryRunner.query(`DROP TYPE "adoptionsRate_type_enum"`);
